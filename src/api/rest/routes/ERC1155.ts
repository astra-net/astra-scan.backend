...
export async function getAllERC1155(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
erc1155Router.get(
  ...
  catchAsync(getUserERC1155Balances)
);
...
erc1155Router.get(
  ...
  catchAsync(getTokenERC1155Balances)
);
...
erc1155Router.get(
  "/token/:address/asset/:tokenID",
  catchAsync(getTokenERC1155AssetDetails)
);
