...
export async function getLogsByBlockNumber(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
export async function getLogsByBlockHash(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
logsRouter.get(
  ...
  catchAsync(getLogsByTransactionHash)
);

export async function getLogsByTransactionHash(
  req: Request,
  res: Response,
  next: NextFunction
) {
