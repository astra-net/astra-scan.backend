...
export type EntityQueryCallback = (
  o: EntityQueryCallbackParams
) => Promise<EntityQueryReturn>;
...
export const listByBlockNumber =
  <T>(
...
export const withEqual =
  (property: EqualFields) => (params: EntityQueryCallbackParams) => {
